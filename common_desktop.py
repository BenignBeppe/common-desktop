...
def pick_page(connection):
    # Pick from favourites and images that hasn't been shown yet.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-a",
        action="store_true",
        help="Marks the current image as a favourite. Favourites won't be deleted after they've been "
    )
    ...
    if args.favourite:
        set_current_status(connection, FAVOURITE)
    connection.close()
